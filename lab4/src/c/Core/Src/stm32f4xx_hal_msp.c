...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(I2S_Audio_SCL_GPIO_Port, I2S_Audio_SCL_Pin);

    HAL_GPIO_DeInit(I2S_Audio_SDA_GPIO_Port, I2S_Audio_SDA_Pin);
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PB11     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(GY521_SCL_GPIO_Port, GY521_SCL_Pin);

    HAL_GPIO_DeInit(GY521_SDA_GPIO_Port, GY521_SDA_Pin);
...
void HAL_I2S_MspDeInit(I2S_HandleTypeDef* hi2s)
{
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC12     ------> I2S3_SD
    */
    HAL_GPIO_DeInit(I2S_WS_DAC1_GPIO_Port, I2S_WS_DAC1_Pin);

    HAL_GPIO_DeInit(GPIOC, I2S_MCK_Pin|I2S_SCK_Pin|I2S_SD_Pin);
